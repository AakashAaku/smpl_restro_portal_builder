...
export default function OrderManagement() {
  ...
  const handleCreateManualOrder = () => {
    ...
    const customerName = manualOrderForm.customerName || "Walk-in";
    const customerPhone = manualOrderForm.customerPhone || "0000000000";
              ...
              <CardContent className="pt-6">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex flex-col gap-3 items-end">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-semibold ${statusColors[order.status as keyof typeof statusColors].bg
          ...
          {selectedOrder && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-semibold ${statusColors[selectedOrder.status as keyof typeof statusColors].bg
